...
const View = () => {
  return (
    ...
    >
      <div
        className=" h-full w-full bg-slate-900 flex justify-center items-center "
      ...
      >
        <div className="z-99 text-white flex items-center justify-center w-[90%] h-full  text-[18px] font-light">
          <div className="flex flex-col justify-center items-center  h-[300px] w-[900px] ">
            <div className="uppercase flex justify-center  font-medium text-[40px] text-center w-[80%] ">
              WELCOME TO OUR SHOP
            </div>
            ...
            <div className="flex w-[340px] justify-between items-center mt-5">
              <button className=" bg-white w-[180px] h-[50px] text-black text-[15px] flex justify-center items-center rounded-md font-bold">
                VIEW COLLECTIONS
              </button>
              <button className="bg-white w-[120px] h-[50px] text-black text-[15px] font-bold flex justify-center items-center rounded-md">
                SHOW NOW
              </button>
            </div>
          </div>
